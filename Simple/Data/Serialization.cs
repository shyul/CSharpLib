...
namespace Shyu
{
    public class Serializer
    {
        ...
        public static object LoadObjectFromTable(DataTable t, int Pt)
        {
            object o = Assembly.GetExecutingAssembly().CreateInstance(t.Rows[Pt][ObjectNameColumnName].ToString());
    ...
    public class TechAnalysisType : Attribute { }
}
